...
urlpatterns = [
    # 1. CAMBIO AQUÍ: Usar la vista que solo lista ACTIVO=TRUE para la URL principal.
    path('equipos/', views.EquipoActivoListAPIView.as_view(), name='api_equipos_list'), 
    # 2. Las rutas para inactivos, desactivar y activar están correctas
    ...
    # 3. Resto de rutas (Detalle, Crear, Modificar, etc.) están bien
