  ...
  data() {
    return {
      ...
      inventarioDocs: [
        ...
        { key: "protocolo_mto", label: "Protocolo de Mantenimiento" },
        { key: "frecuencia_metrologica", label: "Frecuencia Metrológica" },
      ],
      infoMetrologicaAdmin: [
        { key: "mantenimiento", label: "Mantenimiento" },
        { key: "frecuencia_mantenimiento", label: "Frecuencia de Mantenimiento" },
        { key: "calibracion", label: "Calibración" },
        { key: "frecuencia_calibracion", label: "Frecuencia de Calibración" },
      ],
      infoMetrologicaTec: [
